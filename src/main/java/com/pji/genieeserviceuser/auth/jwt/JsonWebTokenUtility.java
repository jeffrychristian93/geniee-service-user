package com.pji.genieeserviceuser.auth.jwt;
...
public class JsonWebTokenUtility {
	...
	public String createJsonWebToken(AuthTokenDetailsDTO authTokenDetailsDTO) {
		String token = Jwts
				.builder()
				.setSubject(authTokenDetailsDTO.userId)
				.claim("email", authTokenDetailsDTO.email)
				.claim("role", authTokenDetailsDTO.roleNames.get(0))
	...
	public AuthTokenDetailsDTO parseAndValidate(String token) {
		...
		try {
			...
			roleNames.add((String) claims.get("role"));
